    ...
    switch (passwordSelectedType) {
      ...
      case PasswordType.standard:
        generator = StandardPasswordGenerator(
          ...
          includeUppercase: incluseUppercase,
                          ...
                          children: [
                            Expanded(
                              child: CheckboxListTile(
                                value: incluseUppercase,
                                onChanged: (value) {
                                  setState(() {
                                    incluseUppercase = value ?? false;
                                  });
                                },
